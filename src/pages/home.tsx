         ...
         <div className="absolute inset-0 bg-[rgba(233,87,26,0.4)]/70" />
          <div className="relative flex-1 flex items-center justify-center">
            ...
            <div className="relative flex flex-col items-center max-w-lg w-full">
              <h2 className="font-jost text-4xl text-white mb-10 text-center">
                Fale Conosco
              </h2>

              <form className="w-full bg-[rgba(233,87,26,0.4)] backdrop-blur-sm rounded-2xl p-5 flex flex-col gap-5">
                <div>
                  <label className="font-jost text-xl block text-white/90 mb-2">Nome</label>
                    <input
                      type="text"
              ...
              <div>
                <label className="font-jost text-xl block text-white/90 mb-2">E-mail</label>
                  <input
                    type="email"
              ...
              <div>
                <label className="font-jost text-xl block text-white/90 mb-2">Mensagem</label>
                  <textarea
                ...
                <button
                  type="submit"
                  className="w-full rounded-full bg-[rgba(234,87,26,1)] hover:bg-[rgb(194,61,4)] hover:cursor-pointer hover:scale-104 transition-all text-white font-jost py-3 mt-1"
                >
                  Enviar
                </button>
              </form>  
              ...
              <div className="absolute left-6 top-1/2 -translate-y-1/2 flex flex-col gap-4">
                <a className="w-12 h-12 rounded-full border border-white flex items-center justify-center hover:bg-white hover:text-orange-700 hover:cursor-pointer duration-[400ms] hover:scale-108 transition-all text-white">
                  <FaInstagram size={28}/> 
                </a>
                <a className="w-12 h-12 rounded-full border border-white flex items-center justify-center hover:bg-white hover:text-orange-700 hover:cursor-pointer duration-[400ms] hover:scale-108 transition-all text-white">
